...
public class ProductManager implements ProductService {
	...
	@Override
	public DataResult<List<Product>> getByProductNameAOrCategoryId(String productName, int categoryId) {
		return new SuccessDataResult<List<Product>>(this.productDao.getByProductNameAOrCategoryId(productName, categoryId), "Data listelendi");
	}
